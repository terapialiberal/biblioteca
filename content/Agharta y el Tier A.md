...
> **Agharta** (o Agartha) es el reino legendario ubicado en el interior de la Tierra. Forensemente, representa el **Búnker de Continuidad** del Tier A. Describe el concepto de una élite que, ante los reseteos del mundo exterior, se retira a instalaciones protegidas (físicas o simbólicas) donde preservan la tecnología y el conocimiento prohibido para reiniciar la civilización una vez que el caos haya pasado. Es el "Gobierno en la Sombra" definitivo.
