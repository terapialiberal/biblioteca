...
*   **Acumulación Silenciosa:** Bancos centrales de Tier B (Rusia, China, India, Polonia) han sido los compradores más agresivos de oro en la última década, operando una salida coordinada del sistema de bonos del Tesoro de EE.UU.
*   **Logística de Soberanía:** El movimiento físico de toneladas de oro es una operación militar encubierta de Tier B que marca el fin de la era de la "globalización pacífica" y el inicio de la era de los bloques regionales fortificados.

### Tier C (Narrativa Pública)
*   "El oro es una reliquia bárbara". "Invertir en oro es de conspiranoicos". Narrativas mediáticas de Tier B diseñadas para que el Tier C mantenga sus ahorros en pesos o dólares (que pierden valor cada día) mientras los bancos centrales hacen exactamente lo contrario.

## Conexiones Clave
- [[Bancos Centrales]] (Los ejecutores)
- [[Patrón Oro]] (El fantasma que regresa)
- [[Guerra de Divisas]] (El contexto estratégico)
- [[Reset Financiero (Great Reset)]] (El objetivo final)

## Por Qué Importa (Estilo Nico)

> "Si el oro es 'una piedra vieja que no sirve para nada', ¿por qué los bancos centrales se están peleando por llevarse sus lingotes a casa? La repatriación de oro es el aviso de que el barco se hunde. Los de arriba te dicen que uses Mercado Pago y que el dólar es seguro, pero ellos están escondiendo lingotes bajo el colchón. Saben que el sistema de papelitos de colores va a explotar y que, cuando todo se vaya al diablo, el que tiene el oro físico es el que manda. Es la desconfianza total entre los ladrones del Tier A: ya no confían ni en dejarse la plata unos a otros."