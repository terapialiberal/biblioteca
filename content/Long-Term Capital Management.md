...
tier-primario: "b"
nivel-evidencia: "medio"
tags: [long, ltcm, reserva, term]
publish: true
---
# Long-Term Capital Management (LTCM): El Fracaso De Los Genios

> [!ABSTRACT] Resumen de Inteligencia
> LTCM fue el experimento fallido de la lite acadmica y financiera de finales de los 90. Dirigido por premios Nobel y ex-operadores de Wall Street, el fondo utiliz modelos matemticos de "riesgo cero" para apalancar sus apuestas de forma demencial (hasta 100 a 1). Su colapso en 1998, tras el default ruso, demostr que el **Tier A** no puede predecir el comportamiento humano ("Cisnes Negros"). Fue el primer gran caso moderno de **Rescate Sistmico**, estableciendo la doctrina de que Wall Street es intocable si su cada amenaza con arrastrar a la Matrix.

## Anlisis De Poder (Matrix)

### Tier B: La Arrogancia De Los Modelos
*   **La Blindness Matemtica:** Los directores (Merton y Scholes, creadores del modelo Black-Scholes) crean que el mercado era una campana de Gauss perfecta. Ignoraron que los eventos de "cola larga" (crisis geopolticas) ocurren con ms frecuencia de la que sugieren sus ecuaciones. El Tier B tecnocrtico fall al intentar reducir la realidad a un algoritmo.
*   **Apalancamiento Extremo:** Con apenas \5 mil millones en capital propio, LTCM controlaba posiciones por \1.25 billones de dlares en derivados. Era una bomba de tiempo financiera.

### Tier A: El Rescate De La Fed (1998)
