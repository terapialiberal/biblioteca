---
publish: true
created: 2026-01-29T19:17:16.594-03:00
modified: 2026-02-27T13:06:46.060-03:00
tags:
  - grobocopatel
  - gustavo
  - monsanto
...
*   "El campo es el motor de la Argentina". "Líder emprendedor e innovador". Narrativas épicas y de "modernización" que el Tier C consume, ignorando que el modelo de "Los Grobo" ha vaciado los pueblos rurales (agricultura sin agricultores) y ha concentrado la riqueza en un sistema financiero que puede desarmarse y mudarse de país con un solo clic.

## Conexiones Clave
- [[Monsanto / Bayer (Glifosato)]] (Sus proveedores de armas biológicas)
- [[Soja (Como Commodity)]] (Su activo principal)
- [[INDEC / Retenciones]] (Su campo de batalla político)
- [[Sojización]] (El proceso de transformación territorial)

## Por Qué Importa (Estilo Nico)

> "Grobocopatel es el que inventó la soja inalámbrica. El tipo no tiene tierra, tiene un sistema. Alquiló el país entero para plantar soja, la roció con veneno de Monsanto y se la vendió a los chinos. Convirtió al campo en una oficina de Wall Street. Se hace el visionario moderno, pero su negocio es exprimir la tierra hasta que no quede nada y después llevarse la guita afuera. Es el símbolo de por qué el asado está caro: porque al sistema de Grobocopatel le conviene más que la pampa produzca comida para chanchos en China que comida para los argentinos. Es el dueño de la red, y en esa red, vos sos solo un consumidor que paga lo que él decide."