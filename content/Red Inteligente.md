...
1. **Demand Side Management (Gestión de la Demanda)**: Eufemismo para el control remoto de termostatos y cargadores de vehículos eléctricos por parte del proveedor, eliminando la capacidad de decisión del usuario sobre su propio confort y movilidad.
2. **Vigilancia del Comportamiento Intramuros**: Uso de algoritmos de desagregación de carga para mapear la vida privada de las familias, recolectando inteligencia que puede ser vendida a aseguradoras o utilizada por el Estado para el perfilamiento social.

## Conexiones Críticas

- [[Agenda 2030]]: El marco legal que exige la digitalización energética.
- [[Internet de las Cosas (IoT)]]: El tejido de dispositivos que se conecta a la Smart Grid.
- [[Cambio Climático (Narrativa)]]: El pretexto moral para el racionamiento digital.
- [[Tecnocracia]]: El modelo de gobierno que se sirve de estas redes.
- [[Ciudades de 15 minutos]]: El entorno urbano diseñado para este nivel de micro-control.

## Conclusión Del Análisis

La Red Inteligente nos enseña que **el progreso que te quita el control del interruptor no es progreso, es servidumbre**. Nos advierte que la "eficiencia" es a menudo la máscara de la expropiación de la intimidad. Para el habitante soberano del Tier C, la resistencia consiste en rechazar la instalación de contadores inteligentes siempre que sea posible, proteger el hogar con filtros de interferencia y fomentar la **Soberanía Energética Fuera de Red** (solar, eólica local, baterías independientes). La libertad real comienza cuando el Estado no puede apagar tu luz pulsando un botón desde una oficina a mil kilómetros de distancia.
