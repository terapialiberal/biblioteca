...
- **Gestión de la Ilusión:** Funcionarios como Jerome Powell ejecutan políticas de _Quantitative Easing_ o subida de tasas para "ajustar" el tablero económico según las necesidades de liquidez del Tier A.
...
```mermaid
graph LR
    BIS(BIS: Reglas Basilea) --> Fed(FED: Emisión Deuda)
    Fed --> Govt(Gobierno EEUU: Gasto/Guerra)
    Govt --> Debt(Bonos del Tesoro)
    Debt --> Fed
    Fed --> Banks(Bancos Tier A: Liquidez)
    Banks --> Population(Tier C: Inflación/Deuda)
```
