...
modified: 2026-02-27T13:23:23.051-03:00
tags:
  - blackrock
  - declaracin
  - patrn
...
```mermaid
graph TD
    House(Casa Rothschild) -->|Arquitectura| BIS(BIS: Basilea)
    House -->|Ideología| Econ(The Economist)
    House -->|Proyecto Geopolítico| Israel(Estado de Israel)
    BIS -->|Reglas| Fed(Banca Central Global)
    Econ -->|Narrativa| Politics(Políticos Tier B)
    Israel -->|Hub Inteligencia/Tecnología| Intel(Tier B: Mossad/CIA)
```
