...
modified: 2026-04-07T11:15:03.239-03:00
tags:
  - atlas
  - neoliberalismo
  - pelerin
...
- **Ventriloquía Académica:** La MPS entrena a intelectuales de Tier B que luego aparecen en televisión como "expertos independientes". Estos agentes repiten narrativas diseñadas en Suiza (austeridad, privatización) como si fueran verdades científicas inevitables.
- **El Laboratorio Chileno:** Miembros clave como **[[Milton Friedman]]** asesoraron la dictadura de Pinochet, demostrando que la MPS prefiere el **Orden de Mercado** por sobre la Democracia Política. Si la libertad económica requiere un autoritarismo transitorio (Tier B militar) para imponerse, la MPS lo valida teóricamente.

## ¸ Mecanismos De Poder

1. **Red Capilar (Atlas Network)**: Más de 500 fundaciones en 100 países que operan coordinadamente para empujar leyes específicas (ej. reformas laborales) bajo la apariencia de iniciativas locales espontáneas.
2. **Prestigio Nobel**: El uso sistemático del Premio Nobel de Economía (una distinción creada por el banco central sueco, no por Nobel) para legitimar a sus miembros (Hayek, Friedman, Stigler, Buchanan) y blindar sus teorías de la crítica.

## Conexiones Críticas

- [[Friedrich Hayek]]: El profeta fundador.
