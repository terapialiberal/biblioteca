...
modified: 2026-05-02T18:42:02.488-03:00
tags:
  - altman
  - energa
  - helion
...
**¿Quién captura qué?**
Altman captura el **Costo Marginal Cero de la Inteligencia**. Al dominar la fusión nuclear ([[Helion]]), busca desacoplar el costo del cómputo de las leyes de la termodinámica tradicionales. Quien tenga energía infinita y barata, dominará la economía global en la era post-laboral.

#### ANÁLISIS DE JUEGO

**Tipo:** signaling / signaling
**Equilibrio actual:** Carrera por el "Moat" (Foso). Altman sabe que los modelos de IA se comoditizan; la ventaja competitiva real reside en la infraestructura física (Energía + Chips).
...
La tesis se invalida si Altman renuncia a sus inversiones en energía nuclear y se convierte en un simple proveedor de software SaaS (Software as a Service) dependiente de la red eléctrica tradicional y de AWS/Google para sus servidores.

#### DEVIL'S ADVOCATE

**Probabilidad: 25%**
Sam Altman es un inversor de riesgo agresivo que simplemente diversifica. Sus apuestas en energía nuclear son intentos loables de resolver el cambio climático y proveer la energía que su empresa inevitablemente necesita para no quebrar.

#### BALAS DE PLATA

- **Helion Microsoft PPA (2023-28)**: El primer contrato de compra de energía de fusión del mundo.
- **Oklo Criticality 2026 Target**: El objetivo de demostrar la viabilidad de la micro-fisión modular este año.
