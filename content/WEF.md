...
```mermaid
graph TD
    TierA(Tier A: BlackRock/Patrones) -->|Financiamiento/Agenda| WEF(WEF: Coordinación Davos)
    WEF -->|Entrenamiento YGL| Leaders(Líderes Tier B: Gabinetes/CEOs)
    Leaders -->|Legislación/ESG| Nation(Naciones: Tier C)
    Nation -->|Recursos/Datos| TierA
```
