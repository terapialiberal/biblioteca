...
| Característica | **Palantir Gotham** | **Palantir Foundry** |
| :--- | :--- | :--- |
| **Objetivo Principal** | Identificación de amenazas y personas. | Integración y optimización de flujos de datos. |
| **Usuarios Clave** | Inteligencia, Militares, Policía. | Corporaciones, Salud, Finanzas. |
| **Metodología** | Análisis de grafos y vínculos criminales. | Creación de un "gemelo digital" de la organización. |
...
- [[Panóptico Digital]]: El marco final donde convergen ambas herramientas.
