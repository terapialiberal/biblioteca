...
> El **Manuscrito Voynich** es un libro ilustrado escrito en un sistema de escritura desconocido. Forensemente, existen dos posibilidades: 1) Es un **Canal de Comunicación Cifrado de Tier A** para la transmisión de protocolos biosociales (botánica y farmacología no humana), o 2) Es una **Operación de Desinformación (Honey Pot)** de Tier B para mantener a los analistas ocupados en un laberinto sin salida.
