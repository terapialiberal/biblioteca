...
modified: 2026-02-27T13:26:03.607-03:00
tags:
  - blackrock
  - materia
  - oscura
...
```mermaid
graph TD
    House(Beneficiarios Tier A: Dinastías/Instituciones) -->|Custodia| Funds(Fondos Vanguard)
    Funds -->|Propiedad| Corp(Vanguard Group Inc)
    Corp -->|Gestión| Funds
    Corp -->|Control de Votos| SP500(S&P 500: Economía Real)
    SP500 -->|Rentas/Dividendos| Funds
```
