...
*   **El Rol de los "Expertos":** El Tier B universitario y científico provee el barniz de autoridad necesario. Un "consenso de expertos" es a menudo una construcción burocrática donde se financia solo la ciencia que apoya la narrativa y se cancela a los disidentes.

## ¸ Mecanismos De Poder

1.  **Sincronización Semántica**: Uso de las mismas palabras y frases ("Safe and Effective", "Build Back Better") en miles de medios distintos para crear una sensación de verdad absoluta por repetición.
2.  **Censura por Algoritmo (Shadowbanning)**: No borrar el mensaje, sino enterrarlo en los resultados de búsqueda, asegurando que el Tier C solo encuentre la versión aprobada.
3.  **Patologización del Disenso**: Etiquetar a quien cuestiona la narrativa como "conspiranoico", "anti-ciencia" o "amenaza a la democracia", movilizando al resto de la masa para que realice la censura social voluntariamente.
