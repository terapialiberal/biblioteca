...
### Tier A: Los Curadores De La Deuda Eterna
* **El Garante de la Fuga:** El prstamo de \57.000 millones del FMI fue una operacin de salvataje para los fondos de inversin de Tier A (como BlackRock y Templeton) que necesitaban salir del riesgo argentino. Macri actu como el "asegurador de salida", transfiriendo la deuda privada de sus socios financieros a la deuda pblica del Estado argentino.
...
* **El Ajuste Invisible:** La devaluacin y la inflacin durante su gestin no fueron errores, sino herramientas de transferencia de ingresos desde el salario (Tier C) hacia el capital concentrado (Tier A).

##  Mecanismos De Poder

1.  **Bicicleta Financiera (Carry Trade)**: La creacin de un esquema de altas tasas de inters en pesos que permiti a los especuladores obtener ganancias extraordinarias en dlares, financiadas con deuda pblica.
2.  **Espionaje Ilegal Sistmico**: El uso de la AFI (Proyecto AMBA, Super Mario Bros) para vigilar ilegalmente a familias de vctimas (ARA San Juan), periodistas y polticos propios, asegurando el control mediante el chantaje potencial.
