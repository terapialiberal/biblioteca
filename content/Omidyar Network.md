...
modified: 2026-05-02T18:37:00.508-03:00
tags:
  - digital
  - edward
  - glenn
...
- **Socio de la Agenda Globalista:** Omidyar Network opera como un tentáculo de la misma matriz que las fundaciones Rockefeller o Gates. Su especialidad es el **"Impact Investing"**, que consiste en convertir problemas sociales en oportunidades de mercado para las corporaciones de Tier A, asegurando que el cambio social nunca signifique una pérdida de poder para la élite financiera.

## ¸ Mecanismos De Poder (Influencia)

1. **Philantro-Capitalism**: El uso de donaciones como "capital de riesgo" para dar forma a las leyes de privacidad y datos de modo que sigan favoreciendo el modelo extractivo del Big Tech.
2. **Captura de Talentos**: Ofrecer salarios de élite a periodistas y activistas de Tier C para que dejen de ser insurgentes fuera del sistema y se conviertan en empleados dentro de una estructura jerárquica y disciplinada.
...
Omidyar Network es el terciopelo que recubre la mano de hierro de Silicon Valley. Su existencia nos recuerda que para el sistema, la forma más eficiente de detener a los críticos es ponerlos en nómina. Al financiar la "verdad", Omidyar se asegura de que solo se hable de los síntomas, nunca del virus de control que él mismo ayudó a crear.
