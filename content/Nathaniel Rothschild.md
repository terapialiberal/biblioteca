...
graph TD
    ...
    classDef tierA fill:#ff0000,stroke:#333,stroke-width:2px,color:#fff;

    classDef tierB fill:#0000ff,stroke:#333,stroke-width:2px,color:#fff;

    classDef assets fill:#333,stroke:#fff,stroke-width:1px,color:#fff;



    Nat[Nat Rothschild]:::tierA -->|Control| Volex[Volex - Cables/Data]:::tierB

    Nat -->|Inversor IPO| Glencore[Glencore - Commodities]:::tierB

    Nat -->|Nexo| Deripaska[Oleg Deripaska]:::tierA

    

    Volex -->|Infraestructura Física| AI[Inteligencia Artificial]:::assets

    Volex -->|Carga| EVs[Vehículos Eléctricos]:::assets

    

    Deripaska -->|Dueño| Rusal[Rusal - Aluminio]:::tierB

    Rusal -.->|Suministro| Glencore

    

    subgraph "Infraestructura Física de la Matrix"
